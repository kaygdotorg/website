...
Transient read errors in [ceph](<./20240125-ceph.md>) (also referred to as spurious read errors) are failures that occur briefly and then resolve on subsequent attempts. Ceph retries the read operation up to four times. If all four attempts fail, Ceph concludes that the disk copy is compromised and shifts to a healthy replica.
...
[^1]: [Ceph Deep Scrub Documentation (official)](https://docs.ceph.io/en/latest/rados/operations/scrub/)  
