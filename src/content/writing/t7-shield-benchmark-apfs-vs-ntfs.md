...
- Test size - 16 GB 
  ...
  ![Samsung PSSD T7 Shield - APFS - 16 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung PSSD T7 Shield - APFS - 16 GB.png>)
  
- Test size - 64 GB 

![Samsung PSSD T7 Shield - APFS - 64 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung PSSD T7 Shield - APFS - 64 GB.png>)
...
![Samsung PSSD T7 Shield - APFS Encrypted - 64 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung PSSD T7 Shield - APFS Encrypted - 64 GB.png>)

## Third Contender - Paragon NTFS

- Test size - 16 GB

![Samsung PSSD T7 Shield - Paragon NTFS - 16 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung PSSD T7 Shield - Paragon NTFS - 16 GB.png>)

- Test size - 64 GB

![Samsung PSSD T7 Shield - Paragon NTFS - 64 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung PSSD T7 Shield - Paragon NTFS - 64 GB.png>)

## Fourth Contender - Tuxera NTFS

- Test size - 16 GB
  
![Samsung PSSD T7 Shield - Tuxera NTFS - 16 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung PSSD T7 Shield - Tuxera NTFS - 16 GB.png>)
- Test size - 64 GB

![Samsung PSSD T7 Shield - Tuxera NTFS - 64 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung PSSD T7 Shield - Tuxera NTFS - 64 GB.png>)

## Last Contender - WIndows NTFS

- Test size - 16 GB

![Samsung T7 Shield - Windows NTFS - 16 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung T7 Shield - Windows NTFS - 16 GB.png>)

- Test size - 64 GB

![Samsung T7 Shield - Windows NTFS - 64 GB](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung T7 Shield - Windows NTFS - 64 GB.png>)

- Test size - Real World Performance Preset

![Samsung T7 Shield - Windows NTFS - Real World Performance Preset](<./t7-shield-benchmark-apfs-vs-ntfs/Samsung T7 Shield - Windows NTFS - Real World Performance Preset.png>)
