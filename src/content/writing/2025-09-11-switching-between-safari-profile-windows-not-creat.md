...
> **Note:** If you don't care about the reasoning behind my use of Safari, you can skip to the next heading.
...
![Safari Menubar File → New Window](/images/ghost/safari-1.png)

From System Settings → Keyboard → Keyboard Shortcuts:

![MacOS Keyboard Shortcuts section from System Settings](/images/ghost/safari-2.png)
...
![Safari Settings for Open Links with Profile](/images/ghost/safari-3.png)
...
<video controls width="100%">
  <source src="/videos/safari-btt-config.mp4" type="video/mp4">
...
**[Download: switch-safari-profile-window.bttpreset](/files/switch-safari-profile-window.bttpreset)** (2 KB)
...
<video controls width="100%">
  <source src="/videos/safari-demo.mp4" type="video/mp4">
