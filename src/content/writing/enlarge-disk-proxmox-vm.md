...
tags:
  ...
  - ext4
  - resize
date: 2024-03-06 23:30
last edited: 2024-12-28 17:18
...
The `growpart` command requires the `cloud-utils` package to be installed[^1].
...
[^1]: [Ask Ubuntu - Resize Partition](https://askubuntu.com/a/937351)