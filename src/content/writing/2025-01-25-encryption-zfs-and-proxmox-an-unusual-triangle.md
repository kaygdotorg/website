---
title: "Encryption, ZFS and Proxmox: An unusual triangle"
slug: "migrating-vms-between-proxmox-nodes-backed-by-zfs-native-encryption"
...
-   [remote-migrate](https://pve.proxmox.com/pve-docs/qm.1.html?ref=kayg.org) (a tool for migrating vms/cts to a remote cluster) could've been it but is blocked by the fact that:
