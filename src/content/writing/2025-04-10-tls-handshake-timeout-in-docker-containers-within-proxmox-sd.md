...
slug: "tls-handshake-timeout-in-docker-containers-within-proxmox-sdn"
description: "If you use docker-compose (like you should), the MTU is still going to be the default of 1500 because every docker compose file is treated as a separate set of services that warrant a separate network."
date: "2025-04-10T16:11:00.000+05:30"
last edited: "2025-09-04T17:06:01.000+05:30"
tags:
  - "Blog"
  - "Proxmox"
draft: false
...
I use Proxmox SDN and a eVPN Zone as my main network [which means the default MTU is 1450](https://pve.proxmox.com/pve-docs/chapter-pvesdn.html?ref=kayg.org#pvesdn_zone_plugin_evpn).

![./docker-mtu-proxmox-sdn/proxmox-sdn-evpn-zone.png](/images/ghost/tls-handshake-timeout-in-docker-containers-within-proxmox-sdn-1768729025126.png)

The VM's network adapters can be [configured quite trivially by setting the MTU value to 1, which just inherits the underlying bridge's MTU](https://kayg.org/blog/bridge-mtus-in-proxmox/).
...
This is problematic because now certain websites are inaccessible but moreso because it breaks comments on my website for users of GitHub and Microsoft. And I am a GitHub user!
...
2.  `systemctl daemon-reload` and `systemctl restart dcoker`
3.  Profit???
...
Not so easy. Turns out, as pointed by [a kind stranger on the internet](https://mlohr.com/docker-mtu/?ref=kayg.org), that only changes the default bridge network MTU in Docker.
