...
This is problematic because now certain websites are inaccessible (see: [bridge-mtu-proxmox](<./bridge-mtu-proxmox.md>)) but moreso because it breaks [comments on my website](<./comments.md>) for users of GitHub and Microsoft. And I am a GitHub user! 
## The Solution
