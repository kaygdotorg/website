...
After installation, I create a separate dataset for Proxmox CT/VMs as zfs create rpool/pve. I name the storage is proxmox as zfs-<deviceclass> to keep it really simple and consistent across differ"
