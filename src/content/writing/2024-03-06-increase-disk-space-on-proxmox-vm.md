...
slug: "increase-disk-space-on-proxmox-vm"
description: "Overview To increase disk space on a Proxmox VM, two steps are required: growing the partition and resizing the filesystem[1]. Commands 1. Grow the partition: g"
