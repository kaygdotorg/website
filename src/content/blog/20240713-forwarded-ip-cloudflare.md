...
![cloudflare-proxy](<./20240713-forwarded-ip-cloudflare/cloudflare-proxy.png>)
...
And once Caddy is restarted, our `X-Forwarded-For` should have IPs in [the format we expect](20240713-x-forwarded-for.md).
...
![cloudflare-transform-rule](<./20240713-forwarded-ip-cloudflare/cloudflare-transform-rule.png>)
