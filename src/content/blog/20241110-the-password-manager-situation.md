...
![strongbox-new-entry](<./20241110-the-password-manager-situation/strongbox-new-entry.png>)

However, it misses the greatest feature of KeepassXC still - AutoType. 

For fields that don't support any kind of auto-fill, even Apple's Passwords.app (yes, like the [disk unlock prompt for an APFS encrypted drive](<./20241110-the-password-manager-situation/disk-encryption-unlock-prompt.png>)), AutoType is extremely useful. 
...
2. Large Text view for any field that makes it super easy to scan from any device - for easy sharing:
   ...
   ![strongbox-large-text-view](<./20241110-the-password-manager-situation/strongbox-large-text-view.png>)
...
![strongbox-database-manager](<./20241110-the-password-manager-situation/strongbox-database-manager.png>)
...
2. Password generation is limited to two variants - "Strong" and "Without special Characters"
   ...
   ![passwords-app-password-generator](<./20241110-the-password-manager-situation/passwords-app-password-generator.png>)
