...
![Saving file with vim fails as regular user](../blog/20260323-sudo-save-with-vim/saving-file-with-vim-fails.mp4)
## The Simple Fix
...
![Saving file with vim suceeds](../blog/20260323-sudo-save-with-vim/saving-file-with-vim-sucessds.mp4)
